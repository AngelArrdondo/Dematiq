...
<div class="admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="save-bar">
      <a href="../../pages/corporativo/Contacto.html" target="_blank" class="btn-admin btn-outline-admin">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
        </svg>
        Ver página
      </a>
      <button class="btn-admin btn-primary-admin" onclick="saveContacto()">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<script>
  ...
  function saveContacto() {
    CM.set('contacto', {
      ...
      whatsappNum: document.getElementById('whatsapp-num').value.trim(),
