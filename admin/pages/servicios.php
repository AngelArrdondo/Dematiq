...
<head>
  ...
  <style>
    ...
    .bdot{width:6px;height:6px;border-radius:50%;background:#a78bfa;animation:bdot 2.2s ease-in-out infinite;}
    @keyframes bdot{0%,100%{opacity:1;box-shadow:0 0 0 0 rgba(167,139,250,.5);}50%{opacity:.7;box-shadow:0 0 0 5px rgba(167,139,250,0);}}
    ...
    .bsci-violet {background:linear-gradient(135deg,#4338ca,#6d28d9);}
    ...
    @media(max-width:600px){.svc-banner{padding:22px 18px;}.banner-section-cards{flex-direction:column;}}
    ...
    .si-violet{background:linear-gradient(135deg,#4338ca,#6d28d9);}
    ...
    .slide-num{width:28px;height:28px;border-radius:8px;background:linear-gradient(135deg,#4338ca,#6d28d9);color:#fff;font-size:.75rem;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;}
    ...
    .img-slot-num{width:16px;height:16px;border-radius:4px;font-size:.6rem;font-weight:800;color:#fff;background:linear-gradient(135deg,#4338ca,#6d28d9);display:flex;align-items:center;justify-content:center;flex-shrink:0;}
    ...
    .img-hover-hint{position:absolute;inset:0;background:rgba(15,23,42,.5);display:flex;align-items:center;justify-content:center;gap:4px;opacity:0;transition:opacity .15s;color:#fff;font-size:.65rem;font-weight:700;backdrop-filter:blur(2px);}
    ...
    /* ─── EMPTY STATE ────────────────────────────────── */
    .svc-empty{text-align:center;padding:40px 24px;color:var(--text-lt);}
    .svc-empty svg{opacity:.15;margin-bottom:10px;}
    .svc-empty p{font-size:.88rem;margin-bottom:4px;}
    .svc-empty strong{color:var(--text);font-size:.82rem;}

    /* ─── ADD BUTTON ─────────────────────────────────── */
    .add-svc-btn{display:flex;align-items:center;justify-content:center;gap:8px;margin:16px 24px;padding:10px;border-radius:12px;border:1.5px dashed #c7d5f0;background:#f7f9ff;color:var(--accent);font-size:.82rem;font-weight:700;cursor:pointer;transition:all .18s;}
    .add-svc-btn:hover{border-color:var(--accent-lt);background:#eef3ff;}
    ...
    .bp-yes{flex:1;background:linear-gradient(135deg,#4338ca,#6d28d9);color:#fff;border:none;cursor:pointer;font-size:.78rem;font-weight:700;padding:8px 0;border-radius:9px;transition:opacity .15s;}
    ...
    /* ─── NAV-AWAY MODAL ─────────────────────────────── */
    .nav-modal-backdrop{position:fixed;inset:0;background:rgba(15,23,42,.55);backdrop-filter:blur(4px);z-index:900;display:flex;align-items:center;justify-content:center;opacity:0;pointer-events:none;transition:opacity .25s;}
    ...
    .nm-btn.primary{background:linear-gradient(135deg,#4338ca,#6d28d9);color:#fff;}
...
<div class="admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="unsaved-notice hidden" id="unsavedNotice">
      ...
      <button class="un-save" onclick="saveServicios()">
    ...
    <div class="save-bar-sticky">
      ...
      <button class="btn-admin btn-outline-admin" onclick="cancelServicios()">
