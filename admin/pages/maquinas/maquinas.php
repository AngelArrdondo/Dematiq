...
<head>
  ...
  <link rel="stylesheet" href="../../assets/css/maquinas/maquinas.css?v=5">
</head>
<body>
    ...
    <div class="section-card" id="secSelector" data-accent="slate" style="animation-delay:.02s">
      <div class="sc-head">
        ...
        <div class="sc-head-text">
          ...
          <p>Elige la página que quieres editar — guarda antes de cambiar. Los nombres (botón "Renombrar / reordenar") también son los que se ven en la barra de navegación pública debajo del título de cada página.</p>
        </div>
...
<script src="../../assets/js/maquinas/maquinas.js?v=5"></script>
